...
home = GeoPoint(latitude=63.197640, longitude=75.453721)
car_id = "m2" 
...
mission = Mission(home=home,
                waypoints=[home,
                           GeoPoint(latitude=63.199938, longitude=75.447715),
                           GeoPoint(latitude=63.201594, longitude=75.450758),
                           GeoPoint(latitude=63.201697, longitude=75.452083),
                           GeoPoint(latitude=63.201682, longitude=75.454963)
                           ],
                speed_limits=[
                    GeoSpecificSpeedLimit(0, 45),
                    GeoSpecificSpeedLimit(1, 45),
                    GeoSpecificSpeedLimit(2, 30),
                    GeoSpecificSpeedLimit(3, 45),
                ],
                armed=True)
mission_planner = MissionPlanner(queues_dir=queues_dir, afcs_present=afcs_present)
mission_planner.set_new_mission(mission=mission)

#=====================================================================================================================================================

sitl = SITL(queues_dir=queues_dir, position=home,car_id=car_id, log_level=LOG_INFO, post_telemetry=afcs_present)
communication_gateway = CommunicationGateway(queues_dir=queues_dir, log_level=LOG_INFO)
control_system = ControlSystem(queues_dir=queues_dir, log_level=LOG_INFO)
navigation_system = NavigationSystem(queues_dir=queues_dir, log_level=LOG_INFO)
